...
object GesturesUiTestUtils {
  ...
  fun quickScale(deltaY: Float, startPoint: PointF? = null, withVelocity: Boolean = true, duration: Long = DEFAULT_GESTURE_DURATION, interrupt: Boolean = false, interruptTemporarily: Boolean = false): ViewAction {
    return object : ViewAction {
      ...
      override fun perform(uiController: UiController, view: View) {
        ...
        performQuickScale(uiController, middlePosition, endPoint, withVelocity, duration, interrupt, interruptTemporarily)
      }
    }
  }
  ...
  private fun performQuickScale(uiController: UiController, startPoint: PointF, endPoint: PointF, withVelocity: Boolean, duration: Long, interrupt: Boolean, interruptTemporarily: Boolean) {
    val eventMinInterval: Long = 10
